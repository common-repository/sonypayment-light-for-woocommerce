jQuery( function($) {
	...
	var spfwc_admin_cvs = {
		...
		init: function() {
			...
			if ( $( '#woocommerce_sonypayment-light_cvs_settlement_fee' ).prop( 'checked' ) ) {
				$( '#woocommerce_sonypayment-light_cvs_settlement_fee_table' ).closest( 'tr' ).show();
			} else {
				$( '#woocommerce_sonypayment-light_cvs_settlement_fee_table' ).closest( 'tr' ).hide();
			}

			$( document ).on( 'change', '#woocommerce_sonypayment-light_cvs_settlement_fee', function() {
		...
		createFeeTable: function() {
			...
			$( '#woocommerce_sonypayment-light_cvs_settlement_fee_table' ).closest( 'td' ).append( fee_table );
